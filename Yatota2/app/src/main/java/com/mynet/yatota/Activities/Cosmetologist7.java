...
public class Cosmetologist7 extends AppCompatActivity {
    ...
    private void populatedata() {
        StringRequest stringRequest= new StringRequest(Request.Method.POST, Endpoints.mikedownload_url, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Cosmetologist7.this, "Something is Wrong :(", Toast.LENGTH_SHORT).show();
