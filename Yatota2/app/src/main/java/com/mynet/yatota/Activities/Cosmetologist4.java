...
public class Cosmetologist4 extends AppCompatActivity {
    ...
    private void populatedata() {
        StringRequest stringRequest= new StringRequest(Request.Method.POST, Endpoints.daviddownload_url, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Cosmetologist4.this, "Something is Wrong :(", Toast.LENGTH_SHORT).show();
