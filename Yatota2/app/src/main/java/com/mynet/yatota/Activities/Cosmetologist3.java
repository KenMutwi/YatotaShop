...
public class Cosmetologist3 extends AppCompatActivity {
    ...
    private void populatedata() {
        StringRequest stringRequest= new StringRequest(Request.Method.POST, Endpoints.alfonsedownload_url, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Cosmetologist3.this, "Something is Wrong :(", Toast.LENGTH_SHORT).show();
