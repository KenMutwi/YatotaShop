...
public class Cosmetologist2 extends AppCompatActivity {
    ...
    private void populatedata() {
        StringRequest stringRequest= new StringRequest(Request.Method.POST, Endpoints.charlodownload_url, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Cosmetologist2.this, "Something is Wrong :(", Toast.LENGTH_SHORT).show();
