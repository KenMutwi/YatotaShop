...
public class Amazondata extends AppCompatActivity {
    ...
    private void populatedata() {
        StringRequest stringRequest= new StringRequest(Request.Method.POST, Endpoints.vijanadownload_url, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Amazondata.this, "Something is Wrong :(", Toast.LENGTH_SHORT).show();
