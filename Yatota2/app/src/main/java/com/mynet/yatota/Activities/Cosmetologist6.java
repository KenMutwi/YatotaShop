...
public class Cosmetologist6 extends AppCompatActivity {
    ...
    private void populatedata() {
        StringRequest stringRequest= new StringRequest(Request.Method.POST, Endpoints.obamadownload_url, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Cosmetologist6.this, "Something is Wrong :(", Toast.LENGTH_SHORT).show();
